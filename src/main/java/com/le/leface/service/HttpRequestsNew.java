...
//			public void run() {
				...
				while (true) {
					FaceppResult rst =  HttpRequestsNew.this.request("info", "get_session", new PostParameters().setSessionId(sessionId));
					try {
...
//		}
	 ...
	 * @param apiSecret
	 */
	public HttpRequestsNew(String apiKey, String apiSecret) {
		super();
		this.apiKey = apiKey;
		this.apiSecret = apiSecret;
	}
	 ...
	 * @param apiSecret
	 */
	public HttpRequestsNew(String apiKey, String apiSecret, boolean debug) {
		super();
		this.apiKey = apiKey;
		this.apiSecret = apiSecret;
	 ...
	 * create a empty {@link HttpRequests} object
	 */
	public HttpRequestsNew(boolean debug) {
		super();
		if (debug) WEBSITE = "http://api.faceplusplus.com/";
	}
